         ...
         <section className="container">
            <div className="flex flex-col justify-between max-sm:gap-20 sm:flex-row">
               <div>
                  ...
                  <Link to={routeConstants.pricing} variant="secondary" className="mt-6">
                     Get Started
                  </Link>
               </div>
               ...
               <div className="grid gap-x-16 grid-cols-2 min-[400px]:grid-cols-3 sm:max-w-sm sm:grid-cols-3 [&_li]:!w-fit">
                  {/* SERVICES */}
                  <ul>
                     <li className="mb-3 text-[hsl(345,100%,91%)]">
                        Services
                     </li>

                     {SERVICES.map((data, index) => (
                        <li key={index} >
                           <Link to={data.href} variant="ghost" className={cn("px-0 font-normal text-primary-foreground hover:bg-transparent hover:text-primary-foreground hover:underline hover:underline-offset-2")}>
                              {data.label}
                           </Link>
                        </li>
                     ))}
                  ...
                  {/* LINKS */}
                  <ul>
                     {MENU_LiST.filter(item => !item.button).map((data, index) => (
                        <li key={index} >
                           <Link to={data.href} variant="ghost" className={cn("px-0 font-normal text-primary-foreground hover:bg-transparent hover:text-primary-foreground hover:underline hover:underline-offset-2", {
                              "text-[hsl(345,100%,91%)]": location.pathname === data.href,
                              "pt-0": index === 0
                           })} >
                              {data.label}
                           </Link>
                  ...
                  <ul>
                     {OTHER_LINKS.map((data, index) => (
                        <li key={index}>
                           <Link to={data.href} variant="ghost" className={cn("!px-0 font-normal text-primary-foreground hover:bg-transparent hover:text-primary-foreground hover:underline hover:underline-offset-2", {
                              "text-[hsl(345,100%,91%)]": location.pathname === data.href,
                              "pt-0 text-[hsl(345,100%,91%)]": index === 0
                           })} >
                              {data.label}
                           </Link>
                        </li>
            ...
            <div className="mt-28">
               ...
               <div className="flex flex-wrap items-center mt-6 justify-normal max-[450px]:gap-y-10 max-[450px]:flex-col">
                  <div id="tc-&-policy" className="flex items-center gap-8 text-primary-foreground *:!text-sm">
